...
export class ContactoComponent {
  ...
  constructor(private authService: AuthService, private veterinariaService: VeterinariaService, public dialogRef: MatDialogRef<ContactoComponent>, @Inject(MAT_DIALOG_DATA) public dataEntrante: string,) {
